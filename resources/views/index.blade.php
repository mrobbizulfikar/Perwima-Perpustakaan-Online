                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <div class="slide-buttons hidden-sm hidden-xs">
                                <a href="#" class="btn btn-primary">Jelajah</a>
                    ...
                    <form action="http://libraria.demo.presstigers.com/index.html" method="get">
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Kata Kunci" id="keywords" name="keywords" type="text">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="welcome-wrap">
                            <div class="welcome-text">
                                <h2 class="section-title">Welcome to the perwima</h2>
            ...
            <div id="category-filter">
                <ul class="category-list">
                    <li class="category-item adults">
                        <figure>
                            <img src="{{ asset('libraria_template/images/category-filter/home-v1/category-filter-img-01.jpg') }}" alt="New Releaase" />
                    ...
                    <li class="category-item kids-teens">
                        <figure>
                            <img src="{{ asset('libraria_template/images/category-filter/home-v1/category-filter-img-02.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item video">
                        <figure>
                            <img src="{{ asset('libraria_template/images/category-filter/home-v1/category-filter-img-03.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item audio">
                        <figure>
                            <img src="{{ asset('libraria_template/images/category-filter/home-v1/category-filter-img-04.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item books">
                        <figure>
                            <img src="{{ asset('libraria_template/images/category-filter/home-v1/category-filter-img-05.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item magazines">
                        <figure>
                            <img src="{{ asset('libraria_template/images/category-filter/home-v1/category-filter-img-06.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item adults">
                        <figure>
                            <img src="{{ asset('libraria_template/images/category-filter/home-v1/category-filter-img-07.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item kids-teens">
                        <figure>
                            <img src="{{ asset('libraria_template/images/category-filter/home-v1/category-filter-img-08.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs-list">
                        <div class="tab-content active">
                            <article>
                                <figure>
                                    <img src="{{ asset('libraria_template/images/latest-blog-img-home-v1.jpg') }}" alt="Latest Blog">
                                    <figcaption>
                                        <a href="#.">
                        ...
                        <div class="tab-content">
                            <article>
                                <figure>
                                    <img src="{{ asset('libraria_template/images/latest-blog-img-home-v1-2.jpg') }}" alt="Latest Blog">
                                    <figcaption>
                                        <a href="#.">
            ...
            <div class="container">
                ...
                <div class="news-events-list">
                    <div class="single-news-event">
                        <figure>
                            <img src="{{ asset('libraria_template/images/news-event/news-event-01.jpg') }}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                    ...
                    <div class="single-news-event">
                        <figure>
                            <img src="{{ asset('libraria_template/images/news-event/news-event-02.jpg') }}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                                <div class="content_meta_category">
                    ...
                    <div class="single-news-event">
                        <figure>
                            <img src="{{ asset('libraria_template/images/news-event/news-event-03.jpg') }}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                                <div class="content_meta_category">
