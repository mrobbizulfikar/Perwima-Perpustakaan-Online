        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light" id="addItem">
                        TAMBAH BARU
                    </button>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control py-0" id="category_id" name="category_id" required="">
                            ...
                            <div class="col-sm">
                                ...
                                <div class="col-sm-12">
                                    <a href="#" onclick="document.getElementById('image_file').click();">
                                        <img src="" id="image" alt="" class="img-thumbnail">
                                    </a>
                                    <input type="file" class="d-none" id="image_file" name="image_file" value="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $(function() {
        ...
        var table = $('#data-table').DataTable({
            ...
            columns: [
                ...
                { data: 'status', name: 'status', class: 'text-center font-weight-bold bg-light',
                    render: function ( data, type, row ) {
                        if(data == 1){
                            return '<span class="text-success">Tersedia</span>';
                        }else{
                            return '<span class="text-danger">Dipinjam</span>';
                        }
                    }
                },
                { data: 'option', name: 'option', class: 'text-center bg-light', orderable: false, searchable: false }
            ],
